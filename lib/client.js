		...
		function AcpAuthBanner({ api, settingsNs, t }) {
			...
			const refresh = (0, react.useCallback)(async () => {
				try {
					...
					const servers = (desc.value.namespaces.find((v) => v.ns === settingsNs)?.value)?.servers ?? {};
					const found = [];
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: pending.map((p) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: AcpSettingsSection_module_css_default.authBanner,
