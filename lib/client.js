window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		* the registry version as a fallback when the server has not reported yet. */
		...
		const css$1 = ".rZ9GEq_container{height:100%;color:var(--dsw-text-primary,#333);flex-direction:column;font-size:13px;display:flex;overflow:hidden}.rZ9GEq_header{border-bottom:1px solid var(--dsw-border,#e0e0e0);flex-shrink:0;justify-content:space-between;align-items:center;padding:8px 12px;display:flex}.rZ9GEq_title{font-weight:600}.rZ9GEq_refreshBtn{border:1px solid var(--dsw-border,#e0e0e0);color:var(--dsw-text-secondary,#666);cursor:pointer;background:0 0;border-radius:4px;padding:4px 12px;font-size:12px}.rZ9GEq_refreshBtn:hover:not(:disabled){border-color:var(--dsw-accent,#1677ff);color:var(--dsw-accent,#1677ff)}.rZ9GEq_refreshBtn:disabled{opacity:.5;cursor:default}.rZ9GEq_empty{text-align:center;color:var(--dsw-text-secondary,#999);padding:24px 12px;font-size:13px}.rZ9GEq_list{flex:1;margin:0;padding:0;list-style:none;overflow-y:auto}.rZ9GEq_item{border-bottom:1px solid var(--dsw-border,#f0f0f0);font-family:var(--dsw-mono,ui-monospace, \"SF Mono\", Menlo, monospace);align-items:baseline;gap:8px;padding:6px 12px;font-size:12px;line-height:1.5;display:flex}.rZ9GEq_time{color:var(--dsw-text-secondary,#999);flex-shrink:0}.rZ9GEq_dir{border-radius:3px;flex-shrink:0;padding:1px 6px;font-size:11px;font-weight:500}.rZ9GEq_send{color:#1677ff;background:#1677ff1a}.rZ9GEq_recv{color:#52c41a;background:#52c41a1a}.rZ9GEq_method{flex-shrink:0;min-width:80px;font-weight:600}.rZ9GEq_server{color:var(--dsw-text-secondary,#999);flex-shrink:0;font-size:11px}.rZ9GEq_summary{color:var(--dsw-text-secondary,#666);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.rZ9GEq_count{color:var(--dsw-text-secondary,#999);background:#0000000f;border-radius:3px;margin-left:4px;padding:0 4px;font-size:10px}";
		...
		*/
		function AcpProtocolView({ api, settingsNs, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), serverIds.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: traces.map(({ server, entry }, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
						className: AcpProtocolView_module_css_default.item,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: `${AcpProtocolView_module_css_default.dir} ${AcpProtocolView_module_css_default[entry.dir]}`,
								children: entry.dir === "send" ? t("protocolSend") : t("protocolRecv")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [entry.summary, entry.count !== void 0 && entry.count > 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
