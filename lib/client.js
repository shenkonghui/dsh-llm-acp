				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [serverIds.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: traces.map((row, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
							className: `${AcpProtocolView_module_css_default.item} ${selected !== null && rowKey(selected) === rowKey(row) ? AcpProtocolView_module_css_default.selected : ""}`,
							onClick: () => {
