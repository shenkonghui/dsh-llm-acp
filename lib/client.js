window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/shenkonghui/src/github/dsh-llm-acp/src/client/AcpSettingsSection.module.css.mjs
		const css$1 = ".GL7WFq_section{flex-direction:column;gap:16px;display:flex}.GL7WFq_heading{margin:0;font-size:18px;font-weight:600}.GL7WFq_intro{color:var(--dsw-text-secondary,#666);margin:0;font-size:14px;line-height:1.5}.GL7WFq_tabs{border-bottom:1px solid var(--dsw-border,#e0e0e0);gap:4px;display:flex}.GL7WFq_tab{cursor:pointer;color:var(--dsw-text-secondary,#666);background:0 0;border:none;border-bottom:2px solid #0000;margin-bottom:-1px;padding:8px 16px;font-size:14px}.GL7WFq_tab[data-active=true]{color:var(--dsw-text-primary,#333);border-bottom-color:var(--dsw-accent,#1677ff);font-weight:500}.GL7WFq_panel{padding-top:16px}.GL7WFq_search{border:1px solid var(--dsw-border,#e0e0e0);box-sizing:border-box;border-radius:6px;width:100%;padding:8px 12px;font-size:14px}.GL7WFq_list{flex-direction:column;gap:8px;display:flex}.GL7WFq_agentCard{border:1px solid var(--dsw-border,#e0e0e0);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:12px;padding:12px 16px;display:flex}.GL7WFq_agentInfo{flex:1;min-width:0}.GL7WFq_agentName{margin:0 0 4px;font-size:14px;font-weight:600}.GL7WFq_agentDesc{color:var(--dsw-text-secondary,#666);margin:0 0 6px;font-size:13px;line-height:1.4}.GL7WFq_agentMeta{color:var(--dsw-text-tertiary,#999);flex-wrap:wrap;gap:12px;font-size:12px;display:flex}.GL7WFq_agentMeta span{align-items:center;gap:4px;display:inline-flex}.GL7WFq_distBadge{background:var(--dsw-bg-secondary,#f0f0f0);color:var(--dsw-text-secondary,#666);border-radius:4px;padding:1px 6px;font-size:11px;font-weight:500;display:inline-block}.GL7WFq_addButton{border:1px solid var(--dsw-accent,#1677ff);background:var(--dsw-accent,#1677ff);color:#fff;cursor:pointer;white-space:nowrap;border-radius:6px;flex-shrink:0;padding:6px 16px;font-size:13px;font-weight:500}.GL7WFq_addButton:disabled{opacity:.6;cursor:not-allowed}.GL7WFq_serverCard{border:1px solid var(--dsw-border,#e0e0e0);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:12px;padding:12px 16px;display:flex}.GL7WFq_removeButton{border:1px solid var(--dsw-danger,#ff4d4f);color:var(--dsw-danger,#ff4d4f);cursor:pointer;background:0 0;border-radius:6px;flex-shrink:0;padding:6px 12px;font-size:13px}.GL7WFq_removeButton:disabled{opacity:.6;cursor:not-allowed}.GL7WFq_empty{text-align:center;color:var(--dsw-text-secondary,#666);padding:24px;font-size:14px}.GL7WFq_error{background:var(--dsw-danger-bg,#fff2f0);color:var(--dsw-danger,#ff4d4f);border-radius:6px;padding:8px 12px;font-size:13px}.GL7WFq_serverCommand{font-family:var(--dsw-font-mono,monospace);color:var(--dsw-text-secondary,#666);font-size:12px}.GL7WFq_serverCardBlock{border:1px solid var(--dsw-border,#e0e0e0);border-radius:8px;overflow:hidden}.GL7WFq_cardActions{flex-shrink:0;gap:8px;display:flex}.GL7WFq_editButton{border:1px solid var(--dsw-border,#e0e0e0);color:var(--dsw-text-primary,#333);cursor:pointer;background:0 0;border-radius:6px;padding:6px 12px;font-size:13px}.GL7WFq_editButton:hover{border-color:var(--dsw-accent,#1677ff);color:var(--dsw-accent,#1677ff)}.GL7WFq_serverDetail{border-top:1px solid var(--dsw-border,#e0e0e0);background:var(--dsw-bg-secondary,#fafafa);flex-direction:column;gap:16px;padding:12px 16px;display:flex}.GL7WFq_detailSection{flex-direction:column;gap:4px;display:flex}.GL7WFq_detailHeading{margin:0;font-size:14px;font-weight:600}.GL7WFq_detailHint{color:var(--dsw-text-tertiary,#999);margin:0 0 4px;font-size:12px;line-height:1.4}.GL7WFq_emptyInline{color:var(--dsw-text-tertiary,#999);margin:0;padding:4px 0;font-size:13px}.GL7WFq_envList{flex-direction:column;gap:6px;display:flex}.GL7WFq_envRow{align-items:center;gap:6px;display:flex}.GL7WFq_envKey{border:1px solid var(--dsw-border,#e0e0e0);font-size:13px;font-family:var(--dsw-font-mono,monospace);box-sizing:border-box;border-radius:4px;flex:2;padding:6px 8px}.GL7WFq_envValue{border:1px solid var(--dsw-border,#e0e0e0);font-size:13px;font-family:var(--dsw-font-mono,monospace);box-sizing:border-box;border-radius:4px;flex:3;padding:6px 8px}.GL7WFq_envRemove{border:1px solid var(--dsw-border,#e0e0e0);width:28px;height:28px;color:var(--dsw-danger,#ff4d4f);cursor:pointer;background:0 0;border-radius:4px;flex-shrink:0;padding:0;font-size:16px;line-height:1}.GL7WFq_envRemove:hover{border-color:var(--dsw-danger,#ff4d4f)}.GL7WFq_addEnvButton{border:1px dashed var(--dsw-border,#e0e0e0);color:var(--dsw-text-secondary,#666);cursor:pointer;background:0 0;border-radius:4px;align-self:flex-start;margin-top:4px;padding:4px 12px;font-size:13px}.GL7WFq_addEnvButton:hover{border-color:var(--dsw-accent,#1677ff);color:var(--dsw-accent,#1677ff)}.GL7WFq_modelList{border:1px solid var(--dsw-border,#e0e0e0);border-radius:4px;flex-direction:column;gap:4px;max-height:240px;padding:4px;display:flex;overflow-y:auto}.GL7WFq_modelSearch{border:1px solid var(--dsw-border,#e0e0e0);box-sizing:border-box;border-radius:4px;width:100%;margin-bottom:4px;padding:6px 10px;font-size:13px}.GL7WFq_modelRow{cursor:pointer;border-radius:4px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;display:flex}.GL7WFq_modelRow:hover{background:var(--dsw-bg-secondary,#f0f0f0)}.GL7WFq_modelRow input[type=checkbox]{flex-shrink:0;margin:0}.GL7WFq_modelName{font-weight:500}.GL7WFq_modelId{font-family:var(--dsw-font-mono,monospace);color:var(--dsw-text-tertiary,#999);font-size:11px}.GL7WFq_modelActions{gap:12px;margin-top:4px;display:flex}.GL7WFq_linkButton{color:var(--dsw-accent,#1677ff);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px}.GL7WFq_linkButton:hover{text-decoration:underline}.GL7WFq_saveButton{border:1px solid var(--dsw-accent,#1677ff);background:var(--dsw-accent,#1677ff);color:#fff;cursor:pointer;border-radius:6px;align-self:flex-start;padding:6px 20px;font-size:13px;font-weight:500}.GL7WFq_saveButton:disabled{opacity:.6;cursor:not-allowed}.GL7WFq_modelSelectHeader{justify-content:space-between;align-items:center;gap:8px;display:flex}.GL7WFq_modelSelectHeader .GL7WFq_detailHeading{margin:0}.GL7WFq_refreshButton{border:1px solid var(--dsw-border,#e0e0e0);color:var(--dsw-text-secondary,#666);cursor:pointer;background:0 0;border-radius:4px;flex-shrink:0;padding:4px 10px;font-size:12px}.GL7WFq_refreshButton:hover:not(:disabled){border-color:var(--dsw-accent,#1677ff);color:var(--dsw-accent,#1677ff)}.GL7WFq_refreshButton:disabled{opacity:.6;cursor:not-allowed}.GL7WFq_versionInfo{flex-wrap:wrap;align-items:center;gap:8px;font-size:13px;display:flex}.GL7WFq_versionName{font-weight:500}.GL7WFq_versionTag{font-family:var(--dsw-font-mono,monospace);color:var(--dsw-text-secondary,#666);background:var(--dsw-bg-secondary,#f0f0f0);border-radius:4px;padding:1px 6px;font-size:12px}";
		...
		var AcpSettingsSection_module_css_default = {
			"versionName": "GL7WFq_versionName",
			"modelList": "GL7WFq_modelList",
			"agentDesc": "GL7WFq_agentDesc",
			"envRemove": "GL7WFq_envRemove",
			"panel": "GL7WFq_panel",
			"envList": "GL7WFq_envList",
			"modelActions": "GL7WFq_modelActions",
			"modelRow": "GL7WFq_modelRow",
			"empty": "GL7WFq_empty",
			"cardActions": "GL7WFq_cardActions",
			"linkButton": "GL7WFq_linkButton",
			"tabs": "GL7WFq_tabs",
			"envValue": "GL7WFq_envValue",
			"search": "GL7WFq_search",
			"saveButton": "GL7WFq_saveButton",
			"agentCard": "GL7WFq_agentCard",
			"emptyInline": "GL7WFq_emptyInline",
			"heading": "GL7WFq_heading",
			"addButton": "GL7WFq_addButton",
			"removeButton": "GL7WFq_removeButton",
			"serverCommand": "GL7WFq_serverCommand",
			"editButton": "GL7WFq_editButton",
			"detailHint": "GL7WFq_detailHint",
			"versionTag": "GL7WFq_versionTag",
			"intro": "GL7WFq_intro",
			"tab": "GL7WFq_tab",
			"distBadge": "GL7WFq_distBadge",
			"agentName": "GL7WFq_agentName",
			"modelSelectHeader": "GL7WFq_modelSelectHeader",
			"serverDetail": "GL7WFq_serverDetail",
			"envKey": "GL7WFq_envKey",
			"agentMeta": "GL7WFq_agentMeta",
			"refreshButton": "GL7WFq_refreshButton",
			"addEnvButton": "GL7WFq_addEnvButton",
			"modelId": "GL7WFq_modelId",
			"detailSection": "GL7WFq_detailSection",
			"modelName": "GL7WFq_modelName",
			"list": "GL7WFq_list",
			"section": "GL7WFq_section",
			"envRow": "GL7WFq_envRow",
			"serverCard": "GL7WFq_serverCard",
			"serverCardBlock": "GL7WFq_serverCardBlock",
			"error": "GL7WFq_error",
			"agentInfo": "GL7WFq_agentInfo",
			"versionInfo": "GL7WFq_versionInfo",
			"detailHeading": "GL7WFq_detailHeading",
			"modelSearch": "GL7WFq_modelSearch"
		};
		//#endregion
		...
		* the registry version as a fallback when the server has not reported yet. */
		...
		function AcpSettingsSection(props) {
				...
				try {
					...
					if (response.ok) {
						...
						if (ns !== void 0) {
							...
							setServers(next);
							for (const id of Object.keys(next)) loadServerInfo(api, settingsNs, id).then((info) => {
			...
			* fetch on every start. */
			...
			const expandServer = async (id) => {
				...
				const [models, info] = await Promise.all([loadProviderModels(api, settingsNs, `acp-${id}`), loadServerInfo(api, settingsNs, id)]);
		...
		//#endregion
		//#region \0dsh-css:/Users/shenkonghui/src/github/dsh-llm-acp/src/client/AcpStatusBar.module.css.mjs
		const css = "._2FyJ3W_wrapper{align-items:center;display:inline-flex;position:relative}._2FyJ3W_trigger{cursor:pointer;color:var(--dsw-alias-label-secondary,#888);background:0 0;border:none;border-radius:4px;align-items:center;gap:6px;padding:2px 4px;font-size:12px;display:inline-flex}._2FyJ3W_trigger:hover{background:var(--dsw-alias-fill-hover,#0000000f)}._2FyJ3W_dot{border-radius:50%;flex-shrink:0;width:8px;height:8px;display:inline-block}._2FyJ3W_dotOk{background:#22c55e}._2FyJ3W_dotWarn{background:#f59e0b}._2FyJ3W_dotErr{background:#ef4444}._2FyJ3W_dotPending{background:var(--dsw-alias-label-tertiary,#bbb)}._2FyJ3W_label{letter-spacing:.02em;font-weight:600}._2FyJ3W_count{font-variant-numeric:tabular-nums;opacity:.8}._2FyJ3W_popover{background:var(--dsw-alias-elevated-fill,#fff);border:1px solid var(--dsw-alias-border,#e0e0e0);z-index:100;border-radius:8px;flex-direction:column;gap:2px;min-width:200px;max-width:280px;padding:6px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;box-shadow:0 4px 16px #0000001f}._2FyJ3W_serverRow{border-radius:4px;align-items:center;gap:8px;padding:4px 6px;font-size:12px;display:flex}._2FyJ3W_serverRow:hover{background:var(--dsw-alias-fill-hover,#0000000a)}._2FyJ3W_serverName{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;font-weight:500;overflow:hidden}._2FyJ3W_serverDetail{color:var(--dsw-alias-label-tertiary,#999);flex-shrink:0;font-size:11px}";
		...
		var AcpStatusBar_module_css_default = {
			"dotOk": "_2FyJ3W_dotOk",
			"dot": "_2FyJ3W_dot",
			"serverRow": "_2FyJ3W_serverRow",
			"dotWarn": "_2FyJ3W_dotWarn",
			"dotPending": "_2FyJ3W_dotPending",
			"label": "_2FyJ3W_label",
			"count": "_2FyJ3W_count",
			"popover": "_2FyJ3W_popover",
			"dotErr": "_2FyJ3W_dotErr",
			"serverName": "_2FyJ3W_serverName",
			"serverDetail": "_2FyJ3W_serverDetail",
			"wrapper": "_2FyJ3W_wrapper",
			"trigger": "_2FyJ3W_trigger"
		};
		//#endregion
