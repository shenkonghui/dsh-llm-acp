// Probe: spawn codebuddy-code --acp, authenticate via iOA, send a prompt,
// and dump every raw session/update payload to inspect thought chunk content.
import { spawn } from 'node:child_process'
import { Readable, Writable } from 'node:stream'
import * as acp from '@agentclientprotocol/sdk'

const child = spawn('/opt/homebrew/bin/codebuddy-code', ['--acp'], {
...
try {
  await conn.authenticate({ methodId: 'iOA' })
  console.log('AUTH> ok')
} catch (e) {
